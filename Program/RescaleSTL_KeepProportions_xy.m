function [ triangles_output ] = RescaleSTL_KeepProportions_xy(triangles, size_target)
%RESCALESTL_KEEPPROPORTIONS_XY rescales a triangular mesh to fit in a box of
% a given target size, keeping the relative proportions in x/y. 
%
% Inputs:
...
% Copyright Nicolas Broguiere. First version 2012. Last edit 2019. 
    ...
    size_factor=min([size_factor_x size_factor_y]);
